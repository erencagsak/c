  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="absolute top-0 left-0 right-0 h-[55vh]">
        ...
        <div className="absolute inset-0 bg-linear-to-br from-purple-900/20 via-transparent to-blue-900/20 animate-pulse" 
             style={{ animationDuration: '3s' }} />
      </div>

      {/* CONTENT CONTAINER */}
      <div className={`relative z-10 h-full flex flex-col items-center justify-between transition-all duration-1000 ${
